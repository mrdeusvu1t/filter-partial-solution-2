...
namespace FilterByPalindromic.Tests
{
    ...
    public class ArrayExtensionTests
    {
        ...
        [TestCase(new[] {-27, 987656789, 7557, int.MaxValue, 7556, 7243, 7243427, int.MinValue},
            ExpectedResult = new[] {7557, 7243427})]
        ...
        public void FilterByPredicate_ArrayIsEmpty_ThrowArgumentException() =>
            Assert.Throws<ArgumentException>(() => new int[] { }.FilterByPredicate(),
                "Array cannot be empty.");

        [Test]
        public void FilterByPredicate_ArrayIsNull_ThrowArgumentNullException() =>
            Assert.Throws<ArgumentNullException>(() => ArrayExtension.FilterByPredicate(null),
